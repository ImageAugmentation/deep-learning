...
# python pytorch/dnn/neural_style_transfer.py --content='pytorch/dnn/assets/neural_style_transfer/input/content.png' --style='pytorch/dnn/assets/neural_style_transfer/style/style.png'